...
class Auth_Admin_Metaboxes {
    ...
    public static function add_meta_boxes() {
        add_meta_box( 
            'booking-information',
            __( 'Booking Information', 'tp-event-auth' ),
    ...
    public static function add_event_fields( $post, $prefix ) {
        ...
        $data_text = !$is_not_free ? __( 'Free', 'tp-event-auth' ) : __( 'Set Price', 'tp-event-auth' );
        $text = $is_not_free ? __( 'Free', 'tp-event-auth' ) : __( 'Set Price', 'tp-event-auth' );
        ?>
        <div class="option_group">
            <p class="form-field">
                <label for="_quantity"><?php _e( 'Qty', 'tp-event-auth' ) ?></label>
        ...
        <div class="option_group<?php echo (!$is_not_free ) ? ' hide-if-js' : ''; ?>">
            ...
            <p class="form-field">
                <label for="_auth_cost"><?php printf( '%s(%s)', __( 'Price', 'tp-event-auth' ), event_auth_get_currency_symbol() ) ?></label>
