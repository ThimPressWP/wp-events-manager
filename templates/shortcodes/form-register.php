...
<form name="event_auth_register_form" action="" method="post" class="event-auth-form">
    ...
    <p class="form-row form-required">
        <label for="user_email"><?php _e( 'Email', 'tp-event' ) ?><span class="required">*</span><br /></label>
    ...
    <p class="form-row form-required">
        <label for="confirm_password"><?php _e( 'Confirm Password', 'tp-event' ) ?><span class="required">*</span><br /></label>
