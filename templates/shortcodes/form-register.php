...
<form name="event_auth_register_form" action="" method="post" class="event-auth-form">
    ...
    <p class="form-row form-required">
        <label for="user_email"><?php _e( 'Email', 'wp-event-manager' ) ?><span class="required">*</span></label>
    ...
    <p class="form-row form-required">
        <label for="confirm_password"><?php _e( 'Confirm Password', 'wp-event-manager' ) ?><span class="required">*</span></label>
    ...
    <?php if ( $send_notify ) : ?>
        <p id="reg_passmail" class="form-row">
            <?php _e( 'Registration confirmation will be emailed to you.', 'wp-event-manager' ); ?>
        </p>
    <?php endif; ?>
    ...
    <p class="submit form-row">
        ...
        <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="<?php esc_attr_e( 'Register', 'wp-event-manager' ); ?>" />
    </p>

</form>

<p id="nav">
    <a href="<?php echo esc_url( tp_event_login_url() ); ?>"><?php _e( 'Log in', 'wp-event-manager' ); ?></a> |
    <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found', 'wp-event-manager' ) ?>"><?php _e( 'Forgot password?', 'wp-event-manager' ); ?></a>
</p>