...
class TP_Event_Frontend_Assets {
	...
	public static function register_scripts( $hook ) {
		...
		TP_Event_Assets::register_style( 'tp-event-owl-carousel-css', WP_EVENT_LIB_URI . '/owl-carousel/css/owl.carousel.css' );

		// magnific-popup
		TP_Event_Assets::register_script( 'tp-event-magnific-popup-js', WP_EVENT_LIB_URI . '/magnific-popup/js/jquery.magnific-popup.min.js', array(), WP_EVENT_VER, true );
		TP_Event_Assets::register_style( 'tp-event-magnific-popup-css', WP_EVENT_LIB_URI . '/magnific-popup/css/magnific-popup.css', array() );

		// events
		TP_Event_Assets::register_script( 'tp-event-frontend-js', WP_EVENT_ASSETS_URI . '/js/frontend/events.js' );
		TP_Event_Assets::register_style( 'tp-event-fronted-css', WP_EVENT_ASSETS_URI . '/css/frontend/events.css' );
	}
