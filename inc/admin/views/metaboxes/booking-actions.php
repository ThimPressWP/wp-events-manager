...
<div id="event-booking-actions" class="booking-actions">
    <label for="booking-status"><?php echo esc_html__( 'Booking Status', 'wp-event-manager' ); ?></label>
    ...
    <p class="booking-status-description"><?php echo esc_html__( 'Update booking event status', 'wp-event-manager' ); ?></p>
</div>
<div id="event-booking-notes" class="booking-notes">
    <label for="booking-notes"><?php echo esc_html__( 'Booking Notes', 'wp-event-manager' ); ?></label>
