...
class WPEMS_Admin_Menu {
	...
	public function admin_menu() {
		...
		add_menu_page( __( 'Events Manager', 'wp-events-manager' ), __( 'Events Manager', 'wp-events-manager' ), 'edit_others_tp_events', 'tp-event-setting', null, 'dashicons-calendar', 9 );
		if ( $menus ) {
